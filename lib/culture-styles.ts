...
export const cultureStyles = {
    sami: {
      ...
      greetingTranslation: "Здравствуйте! Я представитель культуры Саами.",
    ...
    hmong: {
      ...
      greetingTranslation: "Здравствуйте! Я представитель культуры Хмонг.",
    ...
    maori: {
      ...
      greetingTranslation: "Здравствуйте! Я представитель культуры Маори.",
    ...
    inuit: {
      ...
      greetingTranslation: "Здравствуйте! Я представитель культуры Инуитов.",
    ...
    yanomami: {
      ...
      greetingTranslation: "Здравствуйте! Я представитель культуры Яномами.",
    ...
    default: {
      ...
      patternClass: "",
      avatarImage: "/placeholder.svg?height=100&width=100",
      greeting: "Здравствуйте! Я представитель этой культуры.",
      greetingTranslation: "",
      messageStyle: "rounded-lg border-l-4 border-l-amber-500",
      symbolElement: "🌍",
    },
